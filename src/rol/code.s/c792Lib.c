/******************************************************************************
*
*  c792Lib.c  -  Driver library for readout of C.A.E.N. Model 792 QDC
...
return(xferCount);
    ...
    {
      logMsg("c792ReadBlock: ERROR in DMA transfer, retVal=0x%08x(%d), stat=0x%08x(%d bytes)(%d words)\n",
        retVal,retVal,retVal,stat,stat,0);
      C792UNLOCK;
      return(ERROR);
    }
  }
