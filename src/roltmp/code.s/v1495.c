...
v1495ConfigDownload(0x08510000,"/usr/local/clas/parms/trigger/config/g14b/tables/g14b_any2.dat")

v1495ConfigDownload(0x08510000,"/usr/local/clas/parms/trigger/config/g14b/tables/g14b_any2_bit2singleL2.dat")

v1495ConfigDownload(0x08510000,"/usr/local/clas/parms/trigger/config/calib/tables/ec_calib_photon.dat")
*/
...
ProgramPage(Cmd_WritePage *pCmd_WritePage, unsigned int sel_addr, unsigned int rw_addr)
{
  ...
  sysBusToLocalAdrs(0x39, pCmd_WritePage->Address & 0xFFFFFF, (unsigned long *)&pAddr);
...
ProcessRemoteMsg(RemoteMsgStruct *pRemoteMsgStruct)
{
  ...
  switch(pRemoteMsgStruct->MsgType)
  {
	case REMOTE_CMD_READ16:
	{
	  ...
	  sysBusToLocalAdrs(0x39, pCmd_Read16->Address & 0xFFFFFF, (unsigned long *)&pData);
	...
	case REMOTE_CMD_WRITE16:
	{
	  ...
	  sysBusToLocalAdrs(0x39, pCmd_Write16->Address & 0xFFFFFF, (unsigned long *)&pData);
	...
	case REMOTE_CMD_BLKREAD16:
	{
	  ...
	  sysBusToLocalAdrs(0x39, pCmd_BlkRead16->Address & 0xFFFFFF, (unsigned long *)&pData);
	...
	case REMOTE_CMD_READ32:
	{
	  ...
	  sysBusToLocalAdrs(0x39, pCmd_Read32->Address & 0xFFFFFF, (unsigned long *)&pData);
	...
	case REMOTE_CMD_WRITE32:
	{
	  ...
	  sysBusToLocalAdrs(0x39, pCmd_Write32->Address & 0xFFFFFF, (unsigned long *)&pData);
	...
	case REMOTE_CMD_BLKREAD32:
	{
	  ...
	  sysBusToLocalAdrs(0x39, pCmd_BlkRead32->Address & 0xFFFFFF, (unsigned long *)&pData);
