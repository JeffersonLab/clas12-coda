...
printf("faInvert reached, mask=0x%04x\n",chmask);
...
printf("faGetInvertMask return: 0x%04x\n",faGetInvertMask(id));
...
printf("faGetInvertMask return cmask = 0x%04x\n",cmask);
...
/*  printf("faSetChThreshold: slot %d, ch %d, threshold=%d\n",id,ch,threshold);*/
  ...
  return faSetThreshold(id, (unsigned short)threshold, (unsigned short)(1<<ch));
}
