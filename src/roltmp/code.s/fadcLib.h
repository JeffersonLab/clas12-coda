...
//#define FA_SUPPORTED_PROC_FIRMWARE 0x1B04,0x1B05
#define FA_SUPPORTED_PROC_FIRMWARE 0x1B02,0x1B05
#define FA_SUPPORTED_PROC_FIRMWARE_NUMBER 2
...
#define FA_THR_INVERT_MASK     0x4000
...
#define FA_INIT_VXS_TRIG            (2<<1) //(1<<2)
#define FA_INIT_INT_CLKSRC          (0<<4)
#define FA_INIT_FP_CLKSRC           (1<<4)
#define FA_INIT_VXS_CLKSRC          (2<<4) // (1<<5)
#define FA_INIT_P2_CLKSRC           ((1<<4) | (2<<4)) // ((1<<4) | (1<<5))
