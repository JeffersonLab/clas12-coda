...
rcRocW::rcRocW (char* name, rcClientHandler& handler)
:XcodaTopLevel (name), window_ (0), netHandler_ (handler)
{
  int status;
#ifdef _TRACE_OBJECTS
  printf ("         Create rcRocW Class Object\n");
#endif
  // empty
...
{
#ifdef _TRACE_OBJECTS
  printf ("         Delete rcRocW Class Object\n");
#endif
...
Widget
rcRocW::CreateBaseWidget (Widget parent)
{
  Arg arg[20];
  int ac = 0;
  char	  help_file[1000];
