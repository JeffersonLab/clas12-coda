...
/* Sergey: include machine-dependent config file here (was symbolic link) */
...
// Compiler/platform defines thread_t typedef.
...
// for Linux platforms using GNU C++.

// Carl Timmer's additions
// Platform supports System V IPC (most versions of UNIX, but not Win32)
#define ACE_HAS_SYSV_IPC			
