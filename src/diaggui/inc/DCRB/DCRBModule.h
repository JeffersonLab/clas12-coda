...
#define DCRB_SDIOMUX_NAME_MAP   {\
    ...
    static RegMemDesc regs[] = {
      ...
      {NULL, 0},
      {"Serdes0", 0},
        {"GTP_CTRL",      REGMEM_DESC_FLAGS_HEX,   {0x0500, 0, 32, 32}},
        {"GTP_CTRL_TILE0",REGMEM_DESC_FLAGS_HEX,   {0x0504, 0, 32, 32}},
        {"GTP_STATUS",    REGMEM_DESC_FLAGS_HEX,   {0x0510, 0, 32, 32}},
        {"GTP_ERR_TILE0", REGMEM_DESC_FLAGS_HEX,   {0x0518, 0, 32, 32}},
      {NULL, 0},
      {"Serdes1", 0},
        {"GTP_CTRL",      REGMEM_DESC_FLAGS_HEX,   {0x0600, 0, 32, 32}},
        {"GTP_CTRL_TILE0",REGMEM_DESC_FLAGS_HEX,   {0x0604, 0, 32, 32}},
        {"GTP_STATUS",    REGMEM_DESC_FLAGS_HEX,   {0x0610, 0, 32, 32}},
        {"GTP_ERR_TILE0", REGMEM_DESC_FLAGS_HEX,   {0x0618, 0, 32, 32}},
      {NULL, 0},
    };
