...
#define YEAR_MAP {\
    ...
    static RegMemDesc regs[] = {
      ...
      {NULL, 0},
      {"TempMon", 0},
        {"Temp0",           REGMEM_DESC_FLAGS_HEX,    {0x0D00, 0,32, 32}},
        {"Temp1",           REGMEM_DESC_FLAGS_HEX,    {0x0D04, 0,32, 32}},
        {"Temp2",           REGMEM_DESC_FLAGS_HEX,    {0x0D08, 0,32, 32}},
        {"Temp3",           REGMEM_DESC_FLAGS_HEX,    {0x0D0C, 0,32, 32}},
      {NULL, 0},
      {"PetirocCfg", 0},
        {"Ctrl", 0},
