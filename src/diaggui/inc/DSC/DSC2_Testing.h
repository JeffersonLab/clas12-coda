...
//						ps.Close();
	...
	Bool_t CheckTDCBoardId()
	{
		...
		vme_word = pModFrame->ReadReg16((volatile unsigned short int *)(pNumEntryTDCAddr->GetIntNumber()+0x403C));
		val = vme_word & 0xFF;
		vme_word = pModFrame->ReadReg16((volatile unsigned short int *)(pNumEntryTDCAddr->GetIntNumber()+0x4038));
		val |= (vme_word & 0xFF)<<8;
		vme_word = pModFrame->ReadReg16((volatile unsigned short int *)(pNumEntryTDCAddr->GetIntNumber()+0x4034));
